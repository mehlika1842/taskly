...
class Task_Widget extends StatefulWidget {
  ...
  // Yapıcı fonksiyon, named parametreler kullanarak
  Task_Widget({Key? key, required this.note, required this.dueDate}) : super(key: key);
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text(
                    "${widget.dueDate.toLocal()}".split(' ')[0],  // Görev tarihi
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,

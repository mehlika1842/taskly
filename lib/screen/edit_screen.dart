      ...
      children: [
        ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: custom_green,  // 'primary' yerine 'backgroundColor' kullanılıyor
            minimumSize: Size(170, 48),
          ),
          onPressed: () {
            // Güncelleme işlemi
            Firestore_Datasource().Update_Note(
              widget._note.id,      // mevcut id
              indexx,                // yeni seçilen resim index'i
              title!.text,           // yeni başlık
              subtitle!.text,        // yeni açıklama
              DateTime.now()         // Doğrudan DateTime kullanıldı
            );
